...
import investmentConfig from "@/data/investment.json";
...
const { investmentData } = investmentConfig as InvestmentConfig;
                      ...
                      <td className="text-white text-sm lg:text-base py-3 lg:py-4 px-3 lg:px-6 text-center">
                        <div className="space-y-1">
                          <div className="text-white text-sm lg:text-base text-center">
                            {row.date.split(" ")[0]} {row.date.split(" ")[1]}
                          </div>
                        </div>
                      </td>
